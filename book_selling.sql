...
customer_id int primary key identity (1,1) foreign key references Accounts(account_id) NOT NULL,
birthday date,
gender varchar(1),
[name] nvarchar(255),
...
book_genre_id int primary key identity(1,1) NOT NULL,
book_id int foreign key references Books(book_id) NOT NULL,
genre_id int foreign key references Genres(genre_id) NOT NULL,
)
...
VALUES(1, 'admin@gmail.com', '$2a$10$Z90Vo4bSNLhvifpq6eqF.OjCngYLv65hTn7QVngedz8g4r4vYsh6.', 1);
INSERT INTO Accounts
(account_id, email, [password], role_id)
VALUES(2, 'anthony@gmail.com', '$2a$10$ax5PL8Zfrajt48qlm6OT0enq4XFGrYxK6eCF4L9xWHdfeVNYeb55a', 2);
INSERT INTO Accounts
(account_id, email, [password], role_id)
VALUES(3, 'simon@gmail.com', '$2a$10$a/SGBo4iWQgHuKcx8QNS3.XRMmDgPmhRpBCIZv2PEAIKMVHD7oxF.', 2);
INSERT INTO Accounts
(account_id, email, [password], role_id)
VALUES(4, 'tranminhkhang@gmail.com', '$2a$10$/6XE74FmauFskpvfWHTH2uDrpUoPYxq6fjv/7BH7SrhCeyJ5CjdI6', 2);
SET IDENTITY_INSERT Accounts OFF

SET IDENTITY_INSERT Customers ON
INSERT INTO Customers
(customer_id, birthday, gender, [name], [status])
VALUES(1, '2002-12-12', 'm', 'Admin', 1);
INSERT INTO Customers
(customer_id, birthday, gender, [name], [status])
VALUES(2, '2002-11-10', 'm', 'Anthony Doerr', 1);
INSERT INTO Customers
(customer_id, birthday, gender, [name], [status])
VALUES(3, '2002-11-10', 'm', 'Simon Spier', 1);
INSERT INTO Customers
(customer_id, birthday, gender, [name], [status])
VALUES(4, '2022-03-23', 'm', 'Khang', 2);
...
SET IDENTITY_INSERT Book_genre ON
...
(comment_id, "content", rating, comment_date, book_id, customer_id)
VALUES(21, 'hello this is 4 stars', 4.0, '2022-11-09 19:51:25.168', 54, 3);
INSERT INTO Comments
(comment_id, "content", rating, comment_date, book_id, customer_id)
VALUES(22, 'this is 1 star', 1.0, '2022-11-09 19:51:44.417', 54, 3);
INSERT INTO Comments
(comment_id, "content", rating, comment_date, book_id, customer_id)
VALUES(23, '5 stars', 5.0, '2022-11-10 14:51:24.330', 54, 4);
SET IDENTITY_INSERT Comments OFF

SET IDENTITY_INSERT Orders ON
INSERT INTO Orders
(order_id, [address], phone, [status], place_date, total_amount, customer_id)
VALUES(39, 'Thu Duc City, HCM City', '0363111012', 1, '2020-12-12 07:00:00.000', 137.2, 3);
INSERT INTO Orders
(order_id, [address], phone, [status], place_date, total_amount, customer_id)
VALUES(40, 'me', 'take', 1, '2022-11-09 15:36:28.465', 78.95, 3);
INSERT INTO Orders
(order_id, [address], phone, [status], place_date, total_amount, customer_id)
VALUES(41, 'Thu Duc City, HCM City', '0363111012', 1, '2020-12-12 07:00:00.000', 137.2, 3);
INSERT INTO Orders
(order_id, [address], phone, [status], place_date, total_amount, customer_id)
VALUES(42, '123', '123', 1, '2022-11-09 19:48:56.683', 45.7, 3);
INSERT INTO Orders
(order_id, [address], phone, [status], place_date, total_amount, customer_id)
VALUES(43, '456', '123', 1, '2022-11-10 13:07:52.475', 22.85, 3);
INSERT INTO Orders
(order_id, [address], phone, [status], place_date, total_amount, customer_id)
VALUES(44, '678910', '12345', 1, '2022-11-10 13:09:24.526', 66.15, 3);
INSERT INTO Orders
(order_id, [address], phone, [status], place_date, total_amount, customer_id)
VALUES(45, 'Thu Duc HCM', '0933111098', 0, '2022-11-10 14:53:55.799', 0.0, 4);
